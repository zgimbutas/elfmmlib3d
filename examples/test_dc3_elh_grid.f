...
c
     ...
     $     du(3),''
        ...
        call prin2('=== Triangles (analytic+adaptive) ===*',fvec,0)
...
C$        t1=omp_get_wtime()
     ...
     $     ifstraintarg,STRAIN)
        ...
        t2=second()
C$        t2=omp_get_wtime()
        call prin2('elh3dtriadirecttarg: speed, triangles/sec=*',
     $     ntimes*ntri/(t2-t1),1)
...
cc        write(14,2000) target(1), target(2), target(3), er1, er2
cc        write(15,2000) target(1), target(2), target(3), er1, er2
        write(14,2000) target(1), target(2), target(3), 
     $     fvec0(1), fvec0(2), fvec0(3)
