...
FSRCS = elhfmm3dpart_dr.f \
     elfmm3dpart.f el3green.f el3routs.f \
     elhfmm3dpart.f projintker.f projections.f \
     lfmm3dpartmindlin.f lfmm3droutsmindlin.f \
     ...
     lfmm3dparthess.f lfmm3drouts.f \
     d3tstrcr_mindlin.f d3mtreeplot.f  \
     prini.f l3dterms.f helmrouts2.f laprouts2.f laproutshess2.f \
     ...
     legewhts.f rotviarecur3.f rotproj.f dfft.f \
     hkrand.f dlaran.f 
