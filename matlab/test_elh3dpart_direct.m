%
%  Test elastostatic particle FMMs in R^3 (half space)
%
...
'Elastostatic particle target FMM in R^3 (half space)'

tic
iprec=1
[U]=elhfmm3dpart(iprec,rlam,rmu,ntri,source,ifcharge,charge,ifdipole,dipstr,trianorm,ifpot,ifstrain,ntarget,target,ifpottarg,ifstraintarg);
total_time=toc
speed=(ntri+ntarget)/total_time

'Elastostatic particle direct evaluation in R^3 (half space)'

tic
[F]=elh3dpartdirect(rlam,rmu,ntri,source,ifcharge,charge,ifdipole,dipstr,trianorm,ifpot,ifstrain,ntarget,target,ifpottarg,ifstraintarg);
total_time=toc
speed=(ntri+ntarget)/total_time
...
'Elastostatic particle FMM in R^3 (half space)'

tic
iprec=1
[U]=elhfmm3dpart(iprec,rlam,rmu,ntri,source,ifcharge,charge,ifdipole,dipstr,trianorm,ifpot,ifstrain);
total_time=toc
...
tic
[F]=elh3dpartdirect(rlam,rmu,ntri,source,ifcharge,charge,ifdipole,dipstr,trianorm,ifpot,ifstrain);
total_time=toc
speed=(ntri)/total_time
