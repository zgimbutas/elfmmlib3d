...
tic
[U]=elfmm3dpart(iprec,rlam,rmu,nsource,source,ifsingle,sigma_sl,ifdouble,sigma_dl,sigma_dv,ifpot,ifstrain);
total_time=toc;
...
ms = nsource / k;
tic
[F]=el3dpartdirecttime(rlam,rmu,ms,nsource,source,ifsingle,sigma_sl,ifdouble,sigma_dl,sigma_dv,ifpot,ifstrain);
total_time=toc;
