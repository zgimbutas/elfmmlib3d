function [U]=el3dpartdirecttime(rlam,rmu,ms,nsource,source,ifcharge,charge,ifdipole,dipstr,dipvec,ifpot,ifstrain,mt,ntarget,target,ifpottarg,ifstraintarg)
...
mex_id_ = 'el3dpartdirecttargtime(i double[x], i double[x], i int[x], i int[x], i double[xx], i int[x], i double[], i int[x], i double[], i double[xx], i int[x], io double[], i int[x], io double[], i int[x], i int[x], i double[xx], i int[x], io double[], i int[x], io double[])';
