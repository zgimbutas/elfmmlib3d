function [U]=elh3dpartdirect(rlam,rmu,nsource,source,ifcharge,charge,ifdipole,dipstr,dipvec,ifpot,ifstrain,ntarget,target,ifpottarg,ifstraintarg)
...
mex_id_ = 'elh3dpartdirecttarg(i double[x], i double[x], i int[x], i double[xx], i int[x], i double[], i int[x], i double[], i double[xx], i int[x], io double[], i int[x], io double[], i int[x], i double[xx], i int[x], io double[], i int[x], io double[])';
