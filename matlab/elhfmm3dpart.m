function [U]=elhfmm3dpart(iprec,rlam,rmu,nsource,source,ifcharge,charge,ifdipole,dipstr,dipvec,ifpot,ifstrain,ntarget,target,ifpottarg,ifstraintarg)
%ELHFMM3DPART Elastostatic particle target FMM in R^3.
%
...
%
% [U]=ELHFMM3DPART(IPREC,RLAM,RMU,NSOURCE,SOURCE,...
...
if( ntarget == 0 ) 
mex_id_ = 'elhfmm3dpart(io int[x], i int[x], i double[x], i double[x], i int[x], i double[xx], i int[x], i double[], i int[x], i double[], i double[xx], i int[x], io double[], i int[x], io double[])';
...
mex_id_ = 'elhfmm3dparttarg(io int[x], i int[x], i double[x], i double[x], i int[x], i double[xx], i int[x], i double[], i int[x], i double[], i double[xx], i int[x], io double[], i int[x], io double[], i int[x], i double[xx], i int[x], io double[], i int[x], io double[])';
