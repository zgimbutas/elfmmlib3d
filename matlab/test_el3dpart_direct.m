%
%  Test elastostatic particle FMMs in R^3
%
...
'Elastostatic particle target FMM in R^3'

tic
iprec=1
[U]=elfmm3dpart(iprec,rlam,rmu,ntri,source,ifcharge,charge,ifdipole,dipstr,trianorm,ifpot,ifstrain,ntarget,target,ifpottarg,ifstraintarg);
total_time=toc
speed=(ntri+ntarget)/total_time

'Elastostatic particle target direct evaluation in R^3'

tic
[F]=el3dpartdirect(rlam,rmu,ntri,source,ifcharge,charge,ifdipole,dipstr,trianorm,ifpot,ifstrain,ntarget,target,ifpottarg,ifstraintarg);
total_time=toc
speed=(ntri+ntarget)/total_time
...
'Elastostatic particle FMM in R^3'

tic
iprec=1
[U]=elfmm3dpart(iprec,rlam,rmu,ntri,source,ifcharge,charge,ifdipole,dipstr,trianorm,ifpot,ifstrain);
total_time=toc
speed=(ntri)/total_time

'Elastostatic particle direct evaluation in R^3'

tic
[F]=el3dpartdirect(rlam,rmu,ntri,source,ifcharge,charge,ifdipole,dipstr,trianorm,ifpot,ifstrain);
total_time=toc
speed=(ntri)/total_time
