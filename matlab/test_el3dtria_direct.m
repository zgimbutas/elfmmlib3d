...
'Elastostatic triangle target direct evaluation in R^3'
tic
[F]=el3dtriadirect(rlam,rmu,ntri,triangles,trianorm,source,ifcharge,charge,ifdipole,dipstr,ifpot,ifstrain,ntarget,target,ifpottarg,ifstraintarg);
total_time=toc
speed=(ntri+ntarget)/total_time
...
'Elastostatic triangle FMM in R^3'
...
tic
iprec=1
[U]=elfmm3dtria(iprec,rlam,rmu,ntri,triangles,trianorm,source,ifcharge,charge,ifdipole,dipstr,ifpot,ifstrain);
total_time=toc
speed=(ntri)/total_time

'Elastostatic triangle direct evaluation in R^3'

tic
[F]=el3dtriadirect(rlam,rmu,ntri,triangles,trianorm,source,ifcharge,charge,ifdipole,dipstr,ifpot,ifstrain);
total_time=toc
speed=(ntri)/total_time
