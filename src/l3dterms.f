...
c
c    $Date: 2011-06-28 15:49:10 -0600 (Tue, 28 Jun 2011) $
c    $Revision: 2151 $
c
c
c-----------------------------------------------------------------------------
...
c
c      l3dterms_list2 - build the number of terms table for all boxes 
c           in list 2
c
c      l3dterms_list2w - build the number of terms table for all boxes 
c           in list 2, worst case error in multipole to local translation 
c
c      l3dterms_list2e - build the number of terms table for all boxes 
c           in extended list 2
c
c      l3dterms_list2ew - build the number of terms table for all boxes
