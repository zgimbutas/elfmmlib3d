...
c
c    $Date: 2011-06-13 16:37:00 -0400 (Mon, 13 Jun 2011) $
c    $Revision: 2054 $
c
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
c
     ...
     $    ztarg,ntarg,iztarg,w,lw,lused777)
        ...
        integer iz(1),iztarg(1),w(*),laddr(2,1),box(1),nums(1)
        real *8 z(3,1),ztarg(3,1),center(3),corners(3,8)
ccc        save
c
...
c
     ...
     $    ifempty,minlevel,maxlevel)
        implicit real *8 (a-h,o-z)
        integer iz(1),iztarg(1),w(*),laddr(2,1),box(1),nums(1)
        real *8 z(3,1),ztarg(1),center(3),corners(3,8)
ccc        save
c
c        this subroutine constructs the logical structure for the 
c        fully adaptive FMM in three dimensions and stores it in the
...
c
        ...
        integer w(*),box(20)
        dimension center0(3),corners0(3,8)
        dimension laddr(2,200),center(3)
c
c       ... retrieve stored oct-tree parameters 
c
        nboxes=w(1)
...
c
        ...
        implicit real *8 (a-h,o-z)
        integer iz(1),w(*),laddr(1),box(1),nums(1)
...
c
        ...
        implicit real *8 (a-h,o-z)
        integer boxes(20,1),collkids(50000),w(1),
...
c
     ...
     $    ifempty,minlevel,maxlevel,ztarg,ntarg,iztarg)
        implicit real *8 (a-h,o-z)
        integer boxes(20,1),iz(1),iztarg(1),laddr(2,1),iwork(1),
     1      is(8),ns(8),istarg(8),nstarg(8),
     $      iisons(8),jjsons(8),kksons(8)
        real *8 z(3,1),ztarg(3,1),center0(3),center(3)
...
c
     ...
     1    is,ns)
        implicit real *8 (a-h,o-z)
        dimension cent(3),z(3,1),iz(1),iwork(1),is(*),ns(*)
ccc        save
c
...
c
     ...
     1      nboxes,lists,numele,numtype)
        integer listaddr(nboxes,1),lists(2,1),list(1)
ccc        save
c
c       this entry stores dynamically a list of positive numbers 
...
c
        ...
        implicit real *8 (a-h,o-z)
        dimension z(3,1),center(3),corners(3,8)
c
...
c
c
        subroutine d3tgetbtbox(n,z,ntarg,ztarg,center,size,corners)
        implicit real *8 (a-h,o-z)
        dimension z(3,1),ztarg(3,1),center(3),corners(3,8)
c
c       this subroutine finds the center and 
c       corners for the top level box in the oct-tree structure
c
