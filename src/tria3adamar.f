...
c
c
        subroutine tria3adam(ier,vert1,vert2,vert3,fun,nm,
     1      par1,par2,m,eps,rint,maxrec,numfunev,w)
        implicit real *8 (a-h,o-z)
        dimension w(1),par1(1),par2(1),vert1(3),vert2(3),vert3(3),
     1      rint(1)
c
        nrec=200
        ifrel=1
c
        call tria3adamar(ier,vert1,vert2,vert3,fun,nm,
...
c
c
        subroutine tria3adamar(ier,vert1,vert2,vert3,fun,nm,
     1      par1,par2,m,eps,rint,maxrec,numfunev,w,nrec,ifrel)
        implicit real *8 (a-h,o-z)
        dimension w(1),par1(1),par2(1),vert1(3),vert2(3),vert3(3),
     1      rint(1)
...
c       . . . integrate
c
        call tria3nrem(ier,w(istack),vert1,vert2,vert3,fun,nm,
     1      par1,par2,w(iw),m,w(ivals),nnmax,eps,
     2      rint,maxdepth,maxrec,nrec,ifrel,
     $      numint,iiiw,numfunev,w(iww),
...
c
c
        subroutine tria3nrem(ier,stack,vert1,vert2,vert3,fun,nm,
...
c
        numfunev=0
c
cccc        call prinf('in tria3nrem, nm=*',nm,1)
c
        z1(1)=0
        z1(2)=0
        z2(1)=1
...
c
 1000   continue
c
        call tria3inm1(m,vert1,vert2,vert3,z1,z2,z3,fun,
     1      par1,par2,vals(1,1),w,ww,nm,vals2,numnodes)
...
c
     ...
     $     zout(1,1,1),zout(1,2,1),zout(1,3,1),fun,
     1      par1,par2,value1,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        call tria3inm1(m,vert1,vert2,vert3,
     $     zout(1,1,2),zout(1,2,2),zout(1,3,2),fun,
     1      par1,par2,value2,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        call tria3inm1(m,vert1,vert2,vert3,
     $     zout(1,1,3),zout(1,2,3),zout(1,3,3),fun,
     1      par1,par2,value3,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        call tria3inm1(m,vert1,vert2,vert3,
     $     zout(1,1,4),zout(1,2,4),zout(1,3,4),fun,
     1      par1,par2,value4,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        ifdone=1
c
...
c
c
        subroutine tria3inm1(n,vert1,vert2,vert3,z1,z2,z3,fun,
     1      par1,par2,rint,w,work,nm,vals,numnodes)
        implicit real *8 (a-h,o-z)
        dimension vert1(1),vert2(1),vert3(1),
     $     z1(1),z2(1),z3(1),w(1),work(450),
     1      rint(1),vals(1000)
        data nold/-10/
c
...
c
        if( n .le. 50 ) then
        call triasymq(n,z1,z2,z3,w(irnodes),
     1      w(iweights),numnodes)
        endif
c
        if( n .gt. 50 ) then
        call triagauc(n,z1,z2,z3,w(irnodes),
...
c
     ...
     $     numnodes,w(irnodes),w(iweights),fun,par1,par2,
     1     rint,nm,vals)
c
        return
        end
...
c
     ...
     $     numnodes,rnodes,weights,fun,par1,par2,
     1     rint,nm,vals)
        implicit real *8 (a-h,o-z)
        dimension vert1(3),vert2(3),vert3(3)
        dimension rnodes(2,numnodes),weights(numnodes),par1(1),par2(1),
     1    vals(1),rint(1)
c
