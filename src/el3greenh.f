...
c
c
      dimension source(3),du(3),rnorm(3)
      dimension xyz(3),target(3),fvec(3),ftmp(3)
      dimension strain(3,3),dudx(3,3)
      dimension fvecloc(3),sourceim(3),targim(3),rlame(2)
      dimension strainloc(3,3),df(3)
...
c
c
      dimension source(3),target(3),rnorm(3),fvec(3),df(3)
      dimension dfim(3),fvecloc(3),sourceim(3),targim(3),rlame(2)
      dimension strain(3,3),dudx(3,3),strainloc(3,3),xyz(3)
      dimension dipstr(3),dipvec(3)
      dimension UU(3,3,3)
      complex *16 pot,fld(3)
c
c***********************************************************************
...
c
        dimension xyz(3),dtau(3,3),rnorm(3),fout(3),fvec(3),df(3)
        dimension source(3),target(3),delta(3,3),rr(3)
c
        alpha=(rlam+rmu)/(rlam+2*rmu)
c
        do i=1,3
...
c       fout (real *8) - the displacement at the target
c
        dimension xyz(3),rnorm(3),fout(3),fvec(3),du(3)
        dimension delta(3,3),rr(3),source(3),target(3)
        dimension uder(3,3,3),uuu(3)
c
        alpha=(rlam+rmu)/(rlam+2*rmu)
c
        xyz(1) = target(1)-source(1)
